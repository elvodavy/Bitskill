    ...
    return(
        <div className="container-fluid c-container">
            <div className="carousel-container" >
                <Carousel>
                    <Carousel.Item interval={2500} id="carousel-img-container">
                        <img
                    ...
                    <Carousel.Item interval={2500} id="carousel-img-container2">
                        <img
                        className="d-block w-100 carousel-img img-fluid"
                        src={Students}
                        alt="Second slide"
                    ...
                    <Carousel.Item interval={2500} id="carousel-img-container3">
                        <img
                        className="d-block w-100 carousel-img img-fluid"
                        src={Companies}
                        alt="Third slide"
